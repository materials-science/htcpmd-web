		...
		<el-row type="flex" justify="center">
			<el-col :xl="16">
				<el-divider content-position="center"
					><el-tag effect="plain"
						><h2>BTE4ElPh Task Settings</h2></el-tag
					></el-divider
				>
			</el-col>
		</el-row>
 ...
 ******************************************************************************/
import BTECalculation from "./components/BTECalculation";
...
export default {
	...
	data() {
		return {
			label: "",
			calctasks_type_selected_id: "BTECalculation",
			calctasks_type_selected: "BTECalculation",
			calctasks_types: [
				{
					value: "BTECalculation",
					label: "BTECalculation"
				}
			],
		...
		addNewStructure() {
			...
			if (this.structures.length > 0) {
				return this.$message.info(
					"Only support for single calculation of BTE4ElPh Now."
				);
			}
